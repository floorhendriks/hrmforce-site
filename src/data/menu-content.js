...
const A = {
  ...
  kennisbank: ["/kenniscentrum/", "/skills-framework/", "/klantcases/", "/roi-rekentool/", "/voorbereiding/", "/support/f-a-q/", "/oefentest/"],
...
const LABELS = {
  nl: {
    ...
    meer: ["Integraties", "Sectoren"],
    kennisbank: ["Kenniscentrum", "Functie- en skillsdatabase", "Klantcases", "ROI-rekentool", "Voorbereiding", "FAQ", "Oefenen"],
  ...
  en: {
    ...
    kennisbank: ["Knowledge centre", "Job & skills database", "Client cases", "ROI calculator", "Preparation", "FAQ", "Practise"],
  ...
  de: {
    ...
    kennisbank: ["Wissenszentrum", "Berufs- und Skills-Datenbank", "Kundenreferenzen", "ROI-Rechner", "Vorbereitung", "FAQ", "Üben"],
  ...
  fr: {
    ...
    kennisbank: ["Centre de connaissances", "Base de fonctions et compétences", "Cas clients", "Calculateur de ROI", "Préparation", "FAQ", "S'entraîner"],
  ...
  es: {
    ...
    kennisbank: ["Centro de conocimiento", "Base de funciones y competencias", "Casos de clientes", "Calculadora de ROI", "Preparación", "FAQ", "Practicar"],
  ...
  ro: {
    ...
    kennisbank: ["Centru de cunoștințe", "Bază de funcții și competențe", "Studii de caz", "Calculator ROI", "Pregătire", "FAQ", "Exersează"],
