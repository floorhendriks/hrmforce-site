...
export const integratiesContent = {
  nl: {
    ...
    categories: {
      ...
      items: [
        { icon: "doel", title: "ATS / recruitment", text: "Zet assessments klaar vanuit je recruitmentsysteem en laat scores en rapportages terugvloeien naar het kandidaatdossier." },
        { icon: "koppeling", title: "HRIS / kernsysteem", text: "Houd medewerker- en functiegegevens in lijn met je HR-kernsysteem, zodat profielen en trajecten kloppen." },
        { icon: "euro", title: "Payroll / salaris", text: "Sluit aan op je salaris- en personeelsadministratie voor consistente stamgegevens over systemen heen." },
        { icon: "sleutel", title: "SSO / identity", text: "Laat gebruikers inloggen met de identity-provider van je organisatie via single sign-on, met rolgebaseerd toegangsbeheer." },
      ],
    },
    examples: {
      eyebrow: "Voorbeelden",
...
integratiesContent.en.categories.items = [
  { icon: "doel", title: "ATS / recruitment", text: "Launch assessments from your recruitment system and let scores and reports flow back into the candidate file." },
  { icon: "koppeling", title: "HRIS / core system", text: "Keep employee and job data aligned with your HR core system, so profiles and journeys stay accurate." },
  { icon: "euro", title: "Payroll", text: "Connect to your payroll and HR administration for consistent master data across systems." },
  { icon: "sleutel", title: "SSO / identity", text: "Let users sign in with your organisation's identity provider via single sign-on, with role-based access control." },
];
...
integratiesContent.de.categories.items = [
  { icon: "doel", title: "ATS / Recruiting", text: "Starten Sie Assessments aus Ihrem Recruiting-System und lassen Sie Scores und Berichte in die Bewerberakte zurückfließen." },
  { icon: "koppeling", title: "HRIS / Kernsystem", text: "Halten Sie Mitarbeiter- und Stellendaten mit Ihrem HR-Kernsystem im Einklang, damit Profile und Prozesse stimmen." },
  { icon: "euro", title: "Payroll / Lohn", text: "Anbindung an Ihre Lohn- und Personaladministration für konsistente Stammdaten über Systeme hinweg." },
  { icon: "sleutel", title: "SSO / Identity", text: "Lassen Sie Nutzer per Single Sign-on mit dem Identity-Provider Ihrer Organisation anmelden, mit rollenbasierter Zugriffssteuerung." },
];
...
integratiesContent.fr.categories.items = [
  { icon: "doel", title: "ATS / recrutement", text: "Lancez des évaluations depuis votre système de recrutement et faites remonter les scores et rapports dans le dossier du candidat." },
  { icon: "koppeling", title: "SIRH / système central", text: "Gardez les données des collaborateurs et des postes alignées sur votre système RH central, pour des profils et des parcours corrects." },
  { icon: "euro", title: "Paie", text: "Connectez-vous à votre gestion de paie et du personnel pour des données de référence cohérentes entre les systèmes." },
  { icon: "sleutel", title: "SSO / identité", text: "Laissez les utilisateurs se connecter avec le fournisseur d'identité de votre organisation via l'authentification unique, avec un contrôle d'accès basé sur les rôles." },
];
...
integratiesContent.es.categories.items = [
  { icon: "doel", title: "ATS / selección", text: "Lance evaluaciones desde su sistema de selección y haga que las puntuaciones e informes vuelvan al expediente del candidato." },
  { icon: "koppeling", title: "HRIS / sistema central", text: "Mantenga los datos de empleados y puestos alineados con su sistema central de RR. HH., para perfiles y trayectorias correctos." },
  { icon: "euro", title: "Nóminas", text: "Conéctese con su administración de nóminas y personal para datos maestros coherentes entre sistemas." },
  { icon: "sleutel", title: "SSO / identidad", text: "Permita a los usuarios iniciar sesión con el proveedor de identidad de su organización mediante inicio de sesión único, con control de acceso basado en roles." },
];
...
integratiesContent.ro.categories.items = [
  { icon: "doel", title: "ATS / recrutare", text: "Lansați evaluări din sistemul de recrutare și faceți ca scorurile și rapoartele să revină în dosarul candidatului." },
  { icon: "koppeling", title: "HRIS / sistem central", text: "Păstrați datele despre angajați și posturi aliniate cu sistemul HR central, pentru profiluri și parcursuri corecte." },
  { icon: "euro", title: "Salarizare", text: "Conectați-vă la administrarea de salarizare și personal pentru date de referință coerente între sisteme." },
  { icon: "sleutel", title: "SSO / identitate", text: "Permiteși utilizatorilor să se autentifice cu furnizorul de identitate al organizației prin single sign-on, cu control al accesului bazat pe roluri." },
];
