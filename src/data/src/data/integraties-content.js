...
integratiesContent.es.categories.items = [
  ...
  { icon: "💶", title: "Itóminas", text: "Conéctese con su administración de nóminas y personal para datos maestros coherentes entre sistemas." },
...
integratiesContent.ro.categories.items = [
  ...
  { icon: "🔐", title: "SSO / identitate", text: "Permiteți utilizatorilor să se autentifice cu furnizorul de identitate al organizației prin single sign-on, cu control al accesului bazat pe roluri." },
];
