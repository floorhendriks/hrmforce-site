...
export const trustContent = {
  nl: {
    ...
    themes: {
      ...
      items: [
        { icon: "eu", title: "Dataverwerking binnen de EU", text: "Medewerker- en kandidaatgegevens worden binnen de Europese Unie verwerkt en opgeslagen." },
        { icon: "document", title: "AVG + verwerkersovereenkomst", text: "hrmforce houdt zich aan de AVG. Per traject sluiten we een verwerkersovereenkomst af waarin afspraken over gegevensverwerking zijn vastgelegd." },
        { icon: "slot", title: "Versleutelde verbindingen", text: "Gegevens worden via versleutelde verbindingen uitgewisseld tussen kandidaat, portal en jouw organisatie." },
        { icon: "rol", title: "Rolgebaseerd toegangsbeheer", text: "Toegang is rolgebaseerd: gebruikers zien alleen de gegevens en functies die bij hun rol horen." },
        { icon: "kalender", title: "Instelbare bewaartermijnen", text: "Bewaartermijnen zijn per assessment instelbaar, zodat je gegevens niet langer bewaart dan nodig." },
        { icon: "validatie", title: "Wetenschappelijke validatie", text: "Onze assessments zijn wetenschappelijk onderbouwd en worden gereviewd door NIP-geregistreerde psychologen." },
        { icon: "uitwisseling", title: "Transparantie naar kandidaten", text: "Kandidaten weten waarvoor een assessment wordt gebruikt en krijgen inzicht in wat er met hun gegevens gebeurt." },
      ],
    },
    ctaBand: {
...
trustContent.en.themes.items = [
  { icon: "eu", title: "Data processing within the EU", text: "Employee and candidate data is processed and stored within the European Union." },
  { icon: "document", title: "GDPR + data processing agreement", text: "hrmforce complies with the GDPR. For each engagement we sign a data processing agreement setting out how data is handled." },
  { icon: "slot", title: "Encrypted connections", text: "Data is exchanged over encrypted connections between candidate, portal and your organisation." },
  { icon: "rol", title: "Role-based access control", text: "Access is role-based: users only see the data and features that belong to their role." },
  { icon: "kalender", title: "Configurable retention periods", text: "Retention periods can be set per assessment, so you don't keep data longer than necessary." },
  { icon: "validatie", title: "Scientific validation", text: "Our assessments are scientifically grounded and reviewed by NIP-registered psychologists." },
  { icon: "uitwisseling", title: "Transparency towards candidates", text: "Candidates know what an assessment is used for and get insight into what happens with their data." },
];
...
trustContent.de.themes.items = [
  { icon: "eu", title: "Datenverarbeitung innerhalb der EU", text: "Mitarbeiter- und Kandidatendaten werden innerhalb der Europäischen Union verarbeitet und gespeichert." },
  { icon: "document", title: "DSGVO + Auftragsverarbeitungsvertrag", text: "hrmforce hält sich an die DSGVO. Pro Projekt schließen wir einen Auftragsverarbeitungsvertrag, der den Umgang mit Daten festlegt." },
  { icon: "slot", title: "Verschlüsselte Verbindungen", text: "Daten werden über verschlüsselte Verbindungen zwischen Kandidat, Portal und Ihrer Organisation ausgetauscht." },
  { icon: "rol", title: "Rollenbasierte Zugriffssteuerung", text: "Der Zugriff ist rollenbasiert: Nutzer sehen nur die Daten und Funktionen, die zu ihrer Rolle gehören." },
  { icon: "kalender", title: "Einstellbare Aufbewahrungsfristen", text: "Aufbewahrungsfristen lassen sich pro Assessment einstellen, sodass Sie Daten nicht länger als nötig aufbewahren." },
  { icon: "validatie", title: "Wissenschaftliche Validierung", text: "Unsere Assessments sind wissenschaftlich fundiert und werden von NIP-registrierten Psychologen geprüft." },
  { icon: "uitwisseling", title: "Transparenz gegenüber Kandidaten", text: "Kandidaten wissen, wofür ein Assessment verwendet wird, und erhalten Einblick, was mit ihren Daten geschieht." },
];
...
trustContent.fr.themes.items = [
  { icon: "eu", title: "Traitement des données au sein de l'UE", text: "Les données des collaborateurs et des candidats sont traitées et stockées au sein de l'Union européenne." },
  { icon: "document", title: "RGPD + accord de traitement", text: "hrmforce respecte le RGPD. Pour chaque projet, nous signons un accord de traitement des données précisant la façon dont les données sont gérées." },
  { icon: "slot", title: "Connexions chiffrées", text: "Les données sont échangées via des connexions chiffrées entre le candidat, le portail et votre organisation." },
  { icon: "rol", title: "Contrôle d'accès basé sur les rôles", text: "L'accès est basé sur les rôles : les utilisateurs ne voient que les données et fonctions correspondant à leur rôle." },
  { icon: "kalender", title: "Durées de conservation configurables", text: "Les durées de conservation sont configurables par évaluation, afin de ne pas conserver les données plus longtemps que nécessaire." },
  { icon: "validatie", title: "Validation scientifique", text: "Nos évaluations sont fondées scientifiquement et revues par des psychologues enregistrés NIP." },
  { icon: "uitwisseling", title: "Transparence envers les candidats", text: "Les candidats savent à quoi sert une évaluation et comprennent ce qu'il advient de leurs données." },
];
...
trustContent.es.themes.items = [
  { icon: "eu", title: "Tratamiento de datos dentro de la UE", text: "Los datos de empleados y candidatos se tratan y almacenan dentro de la Unión Europea." },
  { icon: "document", title: "RGPD + contrato de encargo", text: "hrmforce cumple el RGPD. En cada proyecto firmamos un contrato de encargo del tratamiento que establece cómo se gestionan los datos." },
  { icon: "slot", title: "Conexiones cifradas", text: "Los datos se intercambian mediante conexiones cifradas entre el candidato, el portal y su organización." },
  { icon: "rol", title: "Control de acceso basado en roles", text: "El acceso se basa en roles: los usuarios solo ven los datos y funciones que corresponden a su rol." },
  { icon: "kalender", title: "Plazos de conservación configurables", text: "Los plazos de conservación se configuran por evaluación, para no conservar los datos más tiempo del necesario." },
  { icon: "validatie", title: "Validación científica", text: "Nuestras evaluaciones tienen base científica y las revisan psicólogos colegiados NIP." },
  { icon: "uitwisseling", title: "Transparencia hacia los candidatos", text: "Los candidatos saben para qué se utiliza una evaluación y conocen qué ocurre con sus datos." },
];
...
trustContent.ro.themes.items = [
  { icon: "eu", title: "Prelucrarea datelor în UE", text: "Datele angajaților și candidaților sunt prelucrate și stocate în cadrul Uniunii Europene." },
  { icon: "document", title: "GDPR + acord de prelucrare", text: "hrmforce respectă GDPR. Pentru fiecare proiect semnăm un acord de prelucrare a datelor care stabilește modul de gestionare a datelor." },
  { icon: "slot", title: "Conexiuni criptate", text: "Datele sunt schimbate prin conexiuni criptate între candidat, portal și organizația dvs." },
  { icon: "rol", title: "Control al accesului bazat pe roluri", text: "Accesul este bazat pe roluri: utilizatorii văd doar datele și funcțiile care corespund rolului lor." },
  { icon: "kalender", title: "Perioade de păstrare configurabile", text: "Perioadele de păstrare pot fi setate pentru fiecare evaluare, ca să nu păstrați datele mai mult decât este necesar." },
  { icon: "validatie", title: "Validare științifică", text: "Evaluările noastre au bază științifică și sunt revizuite de psihologi înregistrați NIP." },
