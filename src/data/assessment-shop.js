...
export const shopMap = {
  ...
  "big-five": { handle: "big-fifty-personality", price: "104.00", segments: ["Persoonlijkheid"], uitgever: "hrmforce" },
  ...
  "cognitieve-test": { handle: "ability-analysis", price: "74.00", segments: ["Capaciteiten"], uitgever: "hrmforce" },
  ...
  "communicatiestijlen-test": { handle: "communication-styles", price: "74.00", segments: ["360 & Gedrag", "Persoonlijkheid", "Vaardigheden"], uitgever: "hrmforce" },
  "competentie-check": { handle: "competency-check", price: "74.00", segments: ["360 & Gedrag"], uitgever: "hrmforce" },
  ...
  "leiderschapstest": { handle: "leadership", price: "74.00", segments: ["Persoonlijkheid"], uitgever: "hrmforce" },
  "leerstijlen": { handle: "learning-styles", price: "74.00", segments: ["Persoonlijkheid"], uitgever: "hrmforce" },
  "15pf": { handle: "15pf", price: "94.00", segments: ["Persoonlijkheid"], uitgever: "hrmforce" },
  "referentie-check": { handle: "reference-check", price: "34.00", segments: ["360 & Gedrag", "Vaardigheden"], uitgever: "hrmforce" },
