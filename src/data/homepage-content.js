...
export const homepageContent = {
  ...
  en: {
    ...
    hero: { eyebrow: "Talent management software", h1pre: "Make better decisions about ", h1em: "people", h1post: "", sub: "Grounded, fast and objective. Scientifically validated assessments for selection, development and teams.", ctaPrimary: "Book a free demo", ctaGhost: "View all assessments", micro: "Reply within 24 hours · no sales pressure · free advice", chooseLabel: "What are you looking for?", chooseSelect: "I want to select", chooseDevelop: "I want to develop", badges: ["Validated", "NIP psychologists", "GDPR-proof (EU)"], trustlink: "How we safeguard quality & GDPR" },
  ...
  de: {
    ...
    hero: { eyebrow: "Talentmanagement-Software", h1pre: "Bessere Entscheidungen über ", h1em: "Menschen", h1post: "", sub: "Fundiert, schnell und objektiv. Wissenschaftlich validierte Assessments für Auswahl, Entwicklung und Teams.", ctaPrimary: "Kostenlose Demo anfragen", ctaGhost: "Alle Assessments ansehen", micro: "Antwort innerhalb von 24 Stunden · kein Verkaufsdruck · unverbindliche Beratung", chooseLabel: "Wonach suchen Sie?", chooseSelect: "Ich möchte auswählen", chooseDevelop: "Ich möchte entwickeln", badges: ["Validiert", "NIP-Psychologen", "DSGVO-konform (EU)"], trustlink: "So sichern wir Qualität & DSGVO" },
